		    ...
		    show: function (o, s, h) {
		        ...
		        if (u.isActive()) n("body", "html").animate({
		            ...
		            c.css({
		                ...
		                var i = "",
							n;
		                for (n in t.buttons) t.buttons.hasOwnProperty(n) && (i = i + '<a href="javascript:;" class="fallr-button ' + (t.buttons[n].danger ? "fallr-button-danger" : "") + '" id="fallr-button-' + n + '">' + t.buttons[n].text + "<\/a>");
		                return i
