...
class Level extends AdminController
{
   ...
   public function initialize()
   {
    ...
    public function getList($runData = false) {
		...
		$viewObj = $this->Model
                    ->alias('l')
                    ->join("vpay_level_where vl", 'l.level_id=vl.level_id', 'left')
                    ->field('l.level_id,l.level_name,vl.*')
                    ->order('vl.grade asc, l.level_id asc');
    ...
    public function info()
    {
        ...
        if ($this->request->isPost()) {
            ...
            // 修改
            	...
            	VpayLevelWhere::where('id', $levelId)->update($arr);
