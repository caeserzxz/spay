...
class VpayRecordCoupon extends BaseModel
{
	protected $table = 'vpay_record_coupon';
	public  $pk = 'id';
	protected static $mkey = 'vpay_record_coupon_list';
    ...
    {
        return $this->hasOne('MakeorderModel', 'id', 'surface_id');
    }
	...
	// 记录信息
	public static function recardCoupon($u_id, $amount, $surfaceName, $surfaceId, $desc = ''){
		$arr = [
			'user_id'      => $u_id,
			'amount'       => $amount,
	...
	// 获取sea券记录 income收入  expenditure支出
	public static function getCouponRecordLst($userId, $param){
